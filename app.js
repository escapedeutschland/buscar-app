const ADMIN_EMAIL = 'maximechristalle@gmail.com';
  ...
  function _ctBuildSteps(){
    return [
      { screen:'screenHome', nav:'navHome', sel:null, icon:'👋', title:L('Willkommen bei Buscar','Bienvenido a Buscar','Welcome to Buscar'), text:L('Schön, dass du da bist! In einer kurzen Tour zeige ich dir die wichtigsten Funktionen.','¡Qué bueno que estés acá! En un tour rápido te muestro las funciones principales.','Great to have you! A quick tour to show you the key features.') },
