const ADMIN_EMAIL = 'maximechristalle@gmail.com';
  ...
  function updateMaklerCta(){
    ...
    el.textContent = (currentLang==='es')
      ? '¿Agente? Destaca tu inmueble y llega a más clientes'
      : 'Makler? Objekt hervorheben & mehr Kunden erreichen';
  }
  function openMaklerModal(listingId){
    ...
    box.innerHTML =
      ...
      +'<div class="makler-price-card">'
        ...
        +'<div class="makler-price-val">USD 15 <span>(~14 €)</span> / '+(es?'30 días':'30 Tage')+'</div>'
      +'</div>'
      +'<div class="makler-price-card">'
        ...
        +'<div class="makler-price-desc">'+(es?'Sello de confianza «verificado» en tus inmuebles.':'Vertrauens-Badge „Verifiziert" an deinen Inseraten.')+'</div>'
        +'<div class="makler-price-val">USD 20 <span>(~18 €)</span> / '+(es?'mes':'Monat')+'</div>'
      +'</div>'
