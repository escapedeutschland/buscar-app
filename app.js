const ADMIN_EMAIL = 'maximechristalle@gmail.com';
  ...
  const translations = {
    de: {
      ...
      report_opt_spam: 'Spam oder Werbung', report_opt_offensive: 'Beleidigend oder unangemessen',
      ...
      wissen_title: 'Ankommen in Paraguay', wissen_sub: 'Praktische Guides fürs Leben in Paraguay', wissen_entry: 'Ankommen in Paraguay', wissen_empty: 'Bald verfügbar – die Guides sind in Arbeit.', wissen_back: 'Zurück zur Übersicht', wissen_disclaimer: 'Ohne Gewähr – bitte immer bei den offiziellen Stellen prüfen.', wissen_updated: 'Stand', wissen_cta: 'Passende Einträge in Buscar finden',
      ...
      fc_ask_send: 'Frage stellen',
      fc_asked: 'Deine Frage ist online!',
      fc_ask_cta: 'Die Community fragen',
      fc_empty_title: 'Noch keine Fragen',
      fc_empty_sub: 'Stell die erste Frage an die Community!',
      ...
      fc_mine: 'Meine Fragen',
      fc_my_answers: 'Meine Antworten',
      fc_no_my_questions: 'Du hast noch keine Frage gestellt',
      fc_no_my_answers: 'Du hast noch nichts beantwortet',
      fc_you_recommended: 'Von dir empfohlen',
      fc_home_sub: 'Finde, was kein Eintrag verrät',
      fc_all: 'Alle',
      ...
      maps_error: 'Konnte den Ort nicht laden. Tipp: Gib statt des kurzen „Teilen"-Links einfach den Namen ein (z. B. „Juan Valdez San Bernardino").',
      ...
      add_photo: 'Foto hinzufügen', uploading: 'Wird hochgeladen...', days_select: 'Tage wählen...', from_time: 'Von...', to_time: 'Bis...', photo_add_label: 'Foto hinzufügen', photo_hint: 'Bitte echte Fotos vom Ort, Team oder Logo – keine Werbeflyer oder App-Store-Banner. Fotos werden nach Prüfung sichtbar.',
    ...
    es: {
      ...
      report_opt_spam: 'Spam o publicidad', report_opt_offensive: 'Ofensivo o inapropiado',
      ...
      wissen_title: 'Llegar a Paraguay', wissen_sub: 'Guías prácticas para vivir en Paraguay', wissen_entry: 'Llegar a Paraguay', wissen_empty: 'Próximamente – las guías están en preparación.', wissen_back: 'Volver al índice', wissen_disclaimer: 'Sin garantía – confirmá siempre con las entidades oficiales.', wissen_updated: 'Actualizado', wissen_cta: 'Encontrar lugares en Buscar',
      ...
      fc_ask_send: 'Publicar pregunta',
      fc_asked: '¡Tu pregunta está publicada!',
      fc_ask_cta: 'Preguntar a la comunidad',
      fc_empty_title: 'Todavía no hay preguntas',
      fc_empty_sub: '¡Hacé la primera pregunta!',
      ...
      fc_mine: 'Mis preguntas',
      fc_my_answers: 'Mis respuestas',
      fc_no_my_questions: 'Todavía no hiciste ninguna pregunta',
      fc_no_my_answers: 'Todavía no respondiste nada',
      fc_you_recommended: 'Recomendado por vos',
      fc_home_sub: 'Encontrá lo que ningún lugar revela',
      fc_all: 'Todas',
      ...
      maps_error: 'No se pudo cargar el lugar. Consejo: en vez del enlace corto para compartir, escribí el nombre (p. ej. «Juan Valdez San Bernardino»).',
      saving: 'Guardando...',
      ...
      add_photo: 'Agregar foto', uploading: 'Subiendo...', days_select: 'Seleccionar día...', from_time: 'Desde...', to_time: 'Hasta...', photo_add_label: 'Agregar foto', photo_hint: 'Subí fotos reales del lugar, el equipo o el logo, no flyers publicitarios ni banners de tiendas de apps. Las fotos se muestran tras la revisión.',
    ...
    en: {
      ...
      report_opt_spam: 'Spam or advertising', report_opt_offensive: 'Offensive or inappropriate',
      ...
      wissen_title: 'Arriving in Paraguay', wissen_sub: 'Practical guides for life in Paraguay', wissen_entry: 'Arriving in Paraguay', wissen_empty: 'Coming soon – guides are in preparation.', wissen_back: 'Back to overview', wissen_disclaimer: 'No guarantee – please always verify with official bodies.', wissen_updated: 'Updated', wissen_cta: 'Find matching places in Buscar',
      ...
      add_photo: 'Add photo', uploading: 'Uploading...', days_select: 'Select days...', from_time: 'From...', to_time: 'To...', photo_add_label: 'Add photo', photo_hint: 'Please upload real photos of the place, team or logo — no ad flyers or app-store banners. Photos appear after review.',
  ...
  var _lastHomeBack = 0;
  // ── Erstellen-Menü (Plus in der Nav): Eintrag / Event / Frage ────────────
  function openCreateSheet(){ var el=document.getElementById('createSheetOverlay'); if(el) el.classList.add('visible'); }
  function closeCreateSheet(){ var el=document.getElementById('createSheetOverlay'); if(el) el.classList.remove('visible'); }
  ...
  function _screenBackTarget(){
    switch (activeScreen){
      ...
      case 'screenQuestions': return 'screenHome';
      case 'screenQuestionDetail': return 'screenQuestions';
  ...
  function _ctBuildSteps(){
    return [
      { screen:'screenHome', nav:'navHome', sel:null, icon:'👋', title:L('Willkommen bei Buscar','Bienvenido a Buscar','Welcome to Buscar'), text:L('Schön, dass du da bist! Eine kurze Tour zeigt dir die wichtigsten Funktionen.','¡Qué bueno que estés acá! Un tour rápido te muestra las funciones principales.','Great to have you! A quick tour shows you the key features.') },
      { screen:'screenHome', nav:'navHome', sel:'#langToggle', title:L('Sprache umschalten','Cambiar idioma','Switch language'), text:L('Stell die App jederzeit auf Deutsch, Español oder English um.','Cambiá la app a alemán, español o inglés cuando quieras.','Switch the app to German, Spanish or English anytime.') },
      ...
      { screen:'screenHome', nav:'navHome', sel:'#catsScroll', title:L('Kategorien & Filter','Categorías y filtros','Categories & filters'), text:L('Filter schnell nach Kategorie – und danach nach Stadt, Bewertung und „spricht deine Sprache".','Filtrá por categoría – y luego por ciudad, calificación e „idioma que habla".','Filter by category – then by city, rating and "speaks your language".') },
      ...
      { screen:'screenMap', nav:'navMap', sel:'.maplibregl-ctrl-geolocate', title:L('Dein Standort','Tu ubicación','Your location'), text:L('Tippen zeigt auf der Karte, wo du gerade bist – praktisch, um Orte in der Nähe zu finden.','Tocá para ver en el mapa dónde estás – ideal para encontrar lugares cerca.','Tap to show where you are on the map – handy to find nearby places.') },
      ...
      { screen:'screenProfil', nav:'navProfil', sel:'#wissenTourTarget', title:L('Ankommen in Paraguay','Llegar a Paraguay','Arriving in Paraguay'), text:L('Praktische Guides + deine „Erste Schritte"-Checkliste fürs Ankommen. Viel Spaß mit Buscar!','Guías prácticas + tu lista de „primeros pasos". ¡Que disfrutes Buscar!','Practical guides + your "first steps" checklist. Enjoy Buscar!') }
    ];
  }
  ...
  function _ctRender(s, el){
    ...
    _ctRoot.style.background = r ? 'transparent' : 'rgba(0,0,0,0.72)'; // ohne Spotlight (Begrüßung): Vollbild abdunkeln
    tip.className = 'ct-tip' + (r ? '' : ' ct-tip-center');
    tip.innerHTML='<div class="ct-caret" id="ctCaret" style="display:none"></div>'
      +(s.icon?'<div class="ct-icon">'+s.icon+'</div>':'')
    ...
    var nx=document.getElementById('ctNext'); nx.onclick=function(){ if(last) _ctFinish(true); else { _ctIdx++; _ctGo(); } };
  ...
  function _doRenderListings() {
    ...
    if (!filtered.length) { var _sq = "'" + String(searchQuery).replace(/\\/g,'\\\\').replace(/'/g,"\\'").replace(/"/g,'&quot;').replace(/</g,'&lt;') + "'"; var _askCta = searchQuery ? '<button class="form-submit" style="margin:18px auto 0;max-width:280px" onclick="openAskQuestion(' + _sq + ')">📣 '+t('fc_ask_cta')+'</button>' : ''; container.innerHTML = '<div class="empty-state"><div class="empty-icon"><svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg></div><div class="empty-title">'+t('nothing_found')+'</div><div class="empty-sub">'+t('nothing_found_sub')+'</div>'+_askCta+'</div>'; return; }
  ...
  // Führt vom Guide zum gefilterten Home-Screen (Kategorie/Unterkategorie/Sprache)
  function applyGuideCta(catId, subcat, lang){
    setNav('navHome'); showScreen('screenHome');
    activeCategory = catId || 'Alle';
    activeSubcat = subcat || 'Alle';
    activeLang = lang || 'Alle';
    activeMinStars = 0; activeTags = []; _tagFilterTemp = [];
    searchQuery = '';
    var si = document.getElementById('searchInput'); if (si) si.value = '';
    var sclr = document.getElementById('searchClear'); if (sclr) sclr.classList.remove('visible');
    document.querySelectorAll('#catsScroll .cat-chip').forEach(function(c){ c.classList.toggle('active', c.dataset.cat === activeCategory); });
    var filterBar = document.getElementById('filterBar');
    if (filterBar) filterBar.style.display = (activeCategory === 'Alle') ? 'none' : 'block';
    var subBtn = document.getElementById('filterSubBtn'), subLabel = document.getElementById('filterSubLabel');
    if (subBtn){ if (activeSubcat !== 'Alle'){ subBtn.classList.add('active'); if(subLabel) subLabel.textContent = tSubcat(activeSubcat); } else { subBtn.classList.remove('active'); if(subLabel) subLabel.textContent = 'Unterkategorie'; } }
    var starBtn = document.getElementById('filterStarBtn'), starLabel = document.getElementById('filterStarLabel');
    if (starBtn){ starBtn.classList.remove('active'); if(starLabel) starLabel.textContent = 'Bewertung'; }
    var tagsBtn = document.getElementById('filterTagsBtn'), tagsLabel = document.getElementById('filterTagsLabel');
    if (tagsBtn){ tagsBtn.classList.remove('active'); if(tagsLabel) tagsLabel.textContent = t('filter_features'); }
    var langBtn = document.getElementById('filterLangBtn'), langLabel = document.getElementById('filterLangLabel');
    if (langBtn){ if (activeLang !== 'Alle'){ langBtn.classList.add('active'); if(langLabel) langLabel.textContent = LANG_NAMES[activeLang]||activeLang; } else { langBtn.classList.remove('active'); if(langLabel) langLabel.textContent = t('filter_lang_title'); } }
    renderListings();
    var lc = document.querySelector('.listings'); if (lc && lc.scrollTo) { lc.scrollTo(0,0); } else if (lc) { lc.scrollTop = 0; }
  }
  ...
  function _qEmpty(title, sub){
    return '<div class="empty-state"><div class="empty-icon"><svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></div><div class="empty-title">'+title+'</div><div class="empty-sub">'+(sub||'')+'</div></div>';
  }
  async function loadQuestions(){
    var list = document.getElementById('questionsList'); if(!list) return;
    list.innerHTML = '<div style="text-align:center;padding:34px;color:var(--text-3)">'+(t('loading')||'…')+'</div>';
    try {
      if(_qBoardMode === 'answers'){
        if(!currentUser){ list.innerHTML = _qEmpty(t('fc_no_my_answers')); return; }
        var snapA = await db.collection('answers').where('created_by','==',currentUser.uid).get();
        var ans = snapA.docs.map(function(d){ return Object.assign({id:d.id}, d.data()); });
        ans.sort(function(a,b){ return _adminTs(b.created_at)-_adminTs(a.created_at); });
        if(!ans.length){ list.innerHTML = _qEmpty(t('fc_no_my_answers')); return; }
        list.innerHTML = ans.map(function(a){
          var l = allListings.find(function(x){ return x.id===a.listing_id; });
          var col = catColors[(l&&l.category_id)] || '#6B6B6B';
          return '<div class="answer-card" onclick="showDetail(\''+a.listing_id+'\')"><div class="answer-dot" style="background:'+col+'"></div><div style="flex:1;min-width:0"><div class="answer-name">'+esc(a.listing_name||(l&&l.name)||'Eintrag')+'</div><div class="answer-note">'+t('fc_you_recommended')+'</div></div><svg class="answer-chev" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" width="16" height="16"><polyline points="9 18 15 12 9 6"/></svg></div>';
        }).join('');
        return;
      }
      var items;
  ...
  function _renderSeekBtn(){
    ...
    var seeking = currentUser && Array.isArray(q.seekers) && q.seekers.indexOf(currentUser.uid)>=0;
    document.getElementById('qdSeekLabel').textContent = seeking ? t('fc_seeking') : t('fc_seek');
    btn.classList.toggle('active-seek', !!seeking);
  }
  async function toggleSeek(){
    ...
    try {
      if(seeking){
        await db.collection('questions').doc(q.id).update({ seekers: firebase.firestore.FieldValue.arrayRemove(currentUser.uid), seekers_count: firebase.firestore.FieldValue.increment(-1) });
        q.seekers = q.seekers.filter(function(u){ return u!==currentUser.uid; }); q.seekers_count = Math.max(0,(q.seekers_count||1)-1);
      } else {
        await db.collection('questions').doc(q.id).update({ seekers: firebase.firestore.FieldValue.arrayUnion(currentUser.uid), seekers_count: firebase.firestore.FieldValue.increment(1) });
        if(!Array.isArray(q.seekers)) q.seekers=[]; q.seekers.push(currentUser.uid); q.seekers_count=(q.seekers_count||0)+1;
      }
  ...
  function renderLegalScreens() {
    ...
    if(el('datenschutzBody')) el('datenschutzBody').innerHTML = L(
      '<p style="font-weight:700;color:var(--text-1);font-size:16px;margin-bottom:12px">Datenschutzerklärung</p><p><strong>Verantwortlicher:</strong><br>Maxime Christalle, San Bernardino, Paraguay, maximechristalle@gmail.com</p><br><p><strong>Erhobene Daten:</strong><br>E-Mail, Benutzername, Profilfoto sowie von dir erstellte Inhalte (Einträge, Fragen, Antworten). Benutzername und Beiträge sind in der App öffentlich sichtbar. Keine Weitergabe an Dritte ohne Einwilligung.</p><br><p><strong>Benachrichtigungen (optional):</strong><br>Aktivierst du Push-Benachrichtigungen, speichern wir einen Geräte-Token, um dir Mitteilungen zu senden (z. B. Antworten auf deine Fragen, Events in deiner Nähe). Der Versand läuft über Firebase Cloud Messaging (Google). Du kannst Benachrichtigungen jederzeit im Profil abschalten.</p><br><p><strong>Standort (optional):</strong><br>Nur wenn du „Events in meiner Nähe" einschaltest, verarbeiten wir deinen ungefähren Standort (auf ca. 11 km gerundet), um passende Events zu melden. Keine Hintergrund-Ortung; jederzeit deaktivierbar.</p><br><p><strong>Firebase (Google):</strong><br>Für Betrieb, Anmeldung, Speicherung und Benachrichtigungen nutzen wir Firebase: <a href="https://firebase.google.com/support/privacy" target="_blank" style="color:var(--yellow)">firebase.google.com/support/privacy</a></p><br><p><strong>Deine Rechte:</strong><br>Auskunft, Berichtigung und Löschung deiner Daten – schreib an maximechristalle@gmail.com.</p><br><p style="color:var(--text-3);font-size:12px">Stand: August 2026</p>',
      '<p style="font-weight:700;color:var(--text-1);font-size:16px;margin-bottom:12px">Política de Privacidad</p><p><strong>Responsable:</strong><br>Maxime Christalle, San Bernardino, Paraguay, maximechristalle@gmail.com</p><br><p><strong>Datos que recopilamos:</strong><br>Correo, nombre de usuario, foto de perfil y el contenido que creás (entradas, preguntas, respuestas). Tu nombre de usuario y tus publicaciones son visibles públicamente en la app. Sin cesión a terceros sin tu consentimiento.</p><br><p><strong>Notificaciones (opcional):</strong><br>Si activás las notificaciones push, guardamos un token del dispositivo para enviarte avisos (p. ej. respuestas a tus preguntas, eventos cerca tuyo). El envío se realiza mediante Firebase Cloud Messaging (Google). Podés desactivarlas cuando quieras en tu perfil.</p><br><p><strong>Ubicación (opcional):</strong><br>Solo si activás „Eventos cerca de mí" procesamos tu ubicación aproximada (redondeada a ~11 km) para avisarte de eventos cercanos. No hay rastreo en segundo plano; podés desactivarlo cuando quieras.</p><br><p><strong>Firebase (Google):</strong><br>Para el funcionamiento, inicio de sesión, almacenamiento y notificaciones usamos Firebase: <a href="https://firebase.google.com/support/privacy" target="_blank" style="color:var(--yellow)">firebase.google.com/support/privacy</a></p><br><p><strong>Tus derechos:</strong><br>Acceso, rectificación y eliminación de tus datos – escribí a maximechristalle@gmail.com.</p><br><p style="color:var(--text-3);font-size:12px">Última actualización: agosto 2026</p>',
